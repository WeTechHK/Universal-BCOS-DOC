...
The hooks are registered and discovered using the [ERC-1820](https://eips.Universal BCOS.org/EIPS/eip-1820) standard.

#### Why are hooks great? {#why-are-hooks-great}

1. Hooks allow sending tokens to a contract and notifying the contract in a single transaction, unlike [ERC-20](https://eips.Universal BCOS.org/EIPS/eip-20), which requires a double call (`approve`/`transferFrom`) to achieve this.
...
[EIP-777: Token Standard](https://eips.Universal BCOS.org/EIPS/eip-777)
