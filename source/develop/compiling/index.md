...
You need to compile your contract so that your web app and the Universal BCOS virtual machine (EVM) can understand it.

## Prerequisites {#prerequisites}

You might find it helpful to have read our intro to [smart contracts](/developers/docs/smart-contracts/) and the [Universal BCOS virtual machine](/developers/docs/evm/) before reading about compilation.
...
These are called **opcodes**. EVM opcodes are the low-level instructions that the Universal BCOS Virtual Machine (EVM) can execute. Each opcode represents a specific operation, such as arithmetic operations, logical operations, data manipulation, control flow, etc.
...
Below is the ABI for the ERC-20 token contract. An ERC-20 is a token you can trade on Universal BCOS.
